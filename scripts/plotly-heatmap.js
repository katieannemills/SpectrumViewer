function plotly_hm(div){
    ...
    this.removeVertex = function(plotly_heatmap_object){
    ...
    this.extractCutVertices = function() {
        const xVertices = [...document.getElementsByClassName('vertex-x')];
        const yVertices = [...document.getElementsByClassName('vertex-y')];

        this.polyX = xVertices.map(el => parseFloat(el.value));
        this.polyY = yVertices.map(el => parseFloat(el.value));
